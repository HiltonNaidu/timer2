...
class main_screen:
    ...
    def link(self):
        ...
        self.duration.text_submit = str(self.active_timer.clock.intial_duration // 60)
        self.name.text_submit = self.active_timer.name
        self.reading_time.text_submit = str(self.active_timer.clock.inital_reading_time // 60)
        ...
        if event.type == pygame.KEYDOWN:
                ...
                if event.key == pygame.K_RETURN:
                    ...
                    try:
                        ...
                        self.active_timer.clock.duration = self.active_timer.clock.intial_duration = int(self.duration.text_submit) * 60
